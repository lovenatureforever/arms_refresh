...
use App\Livewire\Tenant\Pages\ReportConfig\Ntfs\SigAccPolicies;
...
class SigAccPoliciesModal extends ModalComponent
{
    #[Locked]
    public $companyId;
    ...
    {
        return view('livewire.tenant.components.report-config.sig-acc-policies-modal');
    }
    ...
    private function create()
    {
        ...
        try {
            ...
            $this->closeModalWithEvents([
                SigAccPolicies::class => 'successCreated'
            ]);
        } catch (Exception $e) {
            DB::rollBack();
            info($e->getMessage());
    ...
    private function update() {
        ...
        try {
            ...
            $this->closeModalWithEvents([
                SigAccPolicies::class => 'successUpdated'
            ]);
        } catch (Exception $e) {
            DB::rollBack();
            info($e->getMessage());
