...
namespace App\Models\Tenant\v2;
...
use App\Models\Tenant\HasChangeRecords;
...
class Company extends Model
{
    ...
    public function getNameAttribute()
    {
        ...
        return $this->detailChanges()->latest('effective_date')->first()->name ?? $this->attributes['name'] ?? null;
    }
