        ...
        <div class="px-4 py-8 overflow-y-auto">
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div class="col-span-2">
                    <label class="inline-block mb-2 text-sm font-medium text-gray-800" for="title">Title</label>
                    <input class="form-input" id="title" type="text" wire:dirty.class="border-amber-500" wire:model="title">
                </div>
            </div>
        </div>
