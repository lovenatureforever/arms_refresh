<div>
    ...
    <div class="flex items-center justify-between border-b px-4 py-2.5 dark:border-gray-700">
        <h3 class="text-lg font-medium text-gray-800 dark:text-white">
            Create / Update Significant Accounting Policies
        </h3>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <select class="form-input" id="type" name="type" wire:model="type">
                        ...
                        <option value="Paragraph with Roman bullet">Paragraph with Roman bullet</option>
                        ...
                        <option value="Paragraph with underline">Paragraph with underline</option>
                    </select>
                </div>
                <div>
                    <label class="inline-block mb-2 text-sm font-medium text-gray-800" for="mbrs_mapping">MBRS Mapping</label>
                    <select class="form-input" id="mbrs_mapping" name="mbrs_mapping" wire:model="mbrs_mapping">
                        <option>--Select--</option>
                        @foreach (mbrsMappingList() as $mbrsItem)
                            <option value="{{ $mbrsItem }}">{{ $mbrsItem }}</option>
                        @endforeach
                    </select>
                </div>
                {{-- <div>
