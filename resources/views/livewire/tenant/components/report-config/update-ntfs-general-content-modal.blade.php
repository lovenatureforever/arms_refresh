        ...
        <div class="px-4 py-8 overflow-y-auto">
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div class="col-span-2">
                    <label class="inline-block mb-2 text-sm font-medium text-gray-800" for="content">Content</label>
                    <textarea class="form-input" rows="6" id="content" wire:model="content">
                    </textarea>
                    {{-- <input type="text" class="hidden" id="id" wire:model="id"> --}}
                </div>
            </div>
        </div>
