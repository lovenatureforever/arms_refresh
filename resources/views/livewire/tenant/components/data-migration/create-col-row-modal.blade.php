        ...
        <div class="px-4 py-8 overflow-y-auto">
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div class="col-span-2">
                    <label class="inline-block mb-2 text-sm font-medium text-gray-800" for="isRowOrCol">Column/Row</label>
                    <select class="form-input" id="isRowOrCol" name="isRowOrCol" wire:model.live="isRowOrCol">
                ...
                @if ($isRowOrCol == 'col')
                <div class="col-span-2">
                    <label class="inline-block mb-2 text-sm font-medium text-gray-800" for="dataType">DataType</label>
                    <select class="form-input" id="dataType" name="dataType" wire:model.live="dataType">
                ...
                @if ($isRowOrCol == 'row')
                <div class="col-span-2">
                    <label class="inline-block mb-2 text-sm font-medium text-gray-800" for="yearType">Year</label>
                    <select class="form-input" id="yearType" name="yearType" wire:model.live="yearType">
