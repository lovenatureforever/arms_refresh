...
<div>
    <div style="margin-top: 48px; margin-bottom: 48px; margin-left: 32px; margin-right: 32px;">
        ...
        <div>
            THAT the resignation of {{ $data['name'] }} (NRIC No.: {{ $data['passport'] }} ) as the Director of the Company with immediate effect be and is hereby accepted with regret and a vote of thanks be recorded for his past services rendered to the Company.
        </div>
