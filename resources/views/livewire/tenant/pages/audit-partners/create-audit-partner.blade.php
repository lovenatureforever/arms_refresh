    ...
    <div class="card">
        <div class="card-header">
            <div class="flex items-center justify-between">
                <h4 class="card-title">Create Audit Partner</h4>
        ...
        <div class="p-6">
            ...
            <form wire:submit="create">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div>
                        {{-- <label class="mb-2 inline-block text-sm font-medium text-gray-800" for="auditorNo">Auditor No</label>
                        <input class="form-input" id="auditorNo" type="text" wire:model="auditorNo" disabled>
                        @error('auditorNo')
