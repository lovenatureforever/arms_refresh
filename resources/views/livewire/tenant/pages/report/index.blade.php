...
<body>
    ...
    <div class="report-page page-break">
        ...
        <div>
            <div class="text-title chapter">STATEMENT BY {{ count($directors) > 1 ? 'DIRECTORS' : 'DIRECTOR' }} </div>
            <div class="text-bold">Pursuant to Section 251 (2) of the Companies Act 2016</div>
        ...
        @if ($statutory_director_name && $report_setting)
            <div>
                <div class="text-title uppercase">STATUTORY DECLARATION</div>
                <div class="text-bold">Pursuant to Section 251 (1) (b) of the Companies Act 2016</div>
