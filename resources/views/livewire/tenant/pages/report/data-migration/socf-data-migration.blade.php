...
<div>
    ...
    <div class="mt-6 border-b border-gray-200">
        <nav class="flex space-x-4" aria-label="Tabs">
            ...
            <a href="{{ route('datamigration.socf', ['id' => $id]) }}" class="px-3 py-2 font-medium text-sm rounded-t-md {{ ($activeTab ?? 'socf') === 'socf' ? 'bg-white border-l border-t border-r text-blue-600' : 'text-gray-500 hover:text-blue-600' }}">SOCF</a>
                                    ...
                                    @if ($item->type == 'group')
                                        <tr class="bg-gray-200" wire:key="{{ $item->id }}">
                                            <td colspan="4" class="px-3 py-3">
                                                ...
                                                <div class="inline-flex items-center px-1 py-1 mt-1 mr-4 text-center bg-gray-100 border rounded float-end cursor-pointer transition-transform duration-200"
