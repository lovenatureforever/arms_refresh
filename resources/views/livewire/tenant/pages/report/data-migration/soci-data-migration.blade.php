...
<div>
    ...
    <div class="mt-6 border-b border-gray-200">
        <nav class="flex space-x-4" aria-label="Tabs">
            ...
            <a href="{{ route('datamigration.soci', ['id' => $id]) }}" class="px-3 py-2 font-medium text-sm rounded-t-md {{ ($activeTab ?? 'soci') === 'soci' ? 'bg-white border-l border-t border-r text-blue-600' : 'text-gray-500 hover:text-blue-600' }}">SOCI</a>
