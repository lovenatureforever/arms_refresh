@if($isDirector)
    ...
    <div>
        ...
        @if($company)
        <div class="mb-6">
            <h4 class="text-2xl font-bold text-gray-800">{{ $company->name }}</h4>
            <p class="text-gray-500">{{ $company->registration_no }}</p>
        </div>
        @endif
        ...
        @if($director)
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <a href="{{ route('director.cosec.place-order') }}" class="card hover:shadow-md transition">
                    <div class="card-body p-4">
                        <div class="flex items-center gap-3">
                ...
                <a href="{{ route('director.cosec.my-orders') }}" class="card hover:shadow-md transition">
                    <div class="card-body p-4">
                        <div class="flex items-center gap-3">
                            <div class="p-2 bg-blue-100 rounded-lg">
                ...
                <a href="{{ route('profile.credit-history') }}" class="card hover:shadow-md transition">
                    <div class="card-body p-4">
                        <div class="flex items-center gap-3">
                            <div class="p-2 bg-green-100 rounded-lg">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">View transactions</p>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-yellow-700">Please upload your signature from your <a href="{{ route('profile') }}" class="underline">profile</a> to enable document signing.</p>
                    </div>
                </div>
            </div>
            @endif
                ...
                <div class="card-header">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-2">
                            <a class="btn bg-primary text-white" type="button" href="/companies/create">Create</a>
                        </div>
                        @endif
                    </div>
                </div>
