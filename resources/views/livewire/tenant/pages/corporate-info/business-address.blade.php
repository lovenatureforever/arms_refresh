        ...
        <div class="p-6">
            <div class="grid grid-cols-1 gap-5" data-fc-type="tab">
                <nav class="flex-wrap rounded md:flex-col" role="tablist" aria-label="Tabs">
                    ...
                    <a class="btn border border-gray-100 mr-2 mb-2 active bg-primary text-white" role="tab" href="{{ route('corporate.businessaddress', ['id' => $id]) }}">
                        Business Address
                    </a>
                ...
                <div class="col-span-4 p-4 mb-2 mr-2 border border-gray-100 rounded">
                    <div role="tabpanel">
                        ...
                        <div>
                            ...
                            <div class="mt-8 mb-4">
                                <div class="row">
                                    <h1 class="inline text-xl text-primary">Result Summary</h1>
                                    <div class="inline ml-4">
                                        <input class="rounded form-checkbox" id="checkbox-no-biz-addr" type="checkbox" wire:model.live="hasNoBusinessAddress">
                                        <label class="ms-2 form-check-label" for="checkbox-no-biz-addr">No Business Address</label>
                                    </div>
                                </div>
