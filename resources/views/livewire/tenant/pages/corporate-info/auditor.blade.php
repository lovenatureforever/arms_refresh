                            ...
                            <table class="w-[500px]">
                                <tbody>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="p-2">
                                            <input type="text" class="form-input" id="priorAuditFirm1" wire:model="priorAuditFirm" {{ $auditFirmChanged == '1' ? '' : 'disabled' }} />
                                        </td>
                                    </tr>
                                    <tr class="">
                            ...
                            <div class="border rounded-lg overflow-hidden dark:border-gray-700 w-[600px] mt-6">
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200 border-r">Auditor license no.</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200 border-r text-wrap"><b>{{ $auditorModel->selected_license->license_no }}</b><br> Effective Period: {{ $auditorModel->selected_license->effective_date->format('Y-m-d') }} - {{ $auditorModel->selected_license->expiry_date->format('Y-m-d') }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                                <input type="radio" class="form-radio" name="selectedLicense" value="{{ $auditorModel->selected_license->id }}" wire:model="selectedAuditorLicenseId" />
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
...
@script
    <script>
        flatpickr('#priorReportDate', {
            dateFormat: "Y-m-d",
            defaultDate: "{{ $priorReportDate ?? now()->format('Y-m-d') }}",
        });
    </script>
@endscript
