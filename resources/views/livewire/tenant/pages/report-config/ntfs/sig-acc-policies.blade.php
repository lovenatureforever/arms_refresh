<div>
    <table class="box-border min-w-full border border-gray-200 divide-y divide-gray-200 table-fixed dark:divide-gray-700 dark:border-gray-700">
        ...
        <tbody class="divide-y divide-gray-200 dark:divide-gray-700" wire:sortable="updateOrder">
            ...
            <tr wire:sortable.item="{{ $item->id }}" wire:key="sap-{{ $item->id }}">
                ...
                <td class="px-6 py-4 text-sm font-medium text-gray-800 dark:text-gray-200 max-w-[200px] text-ellipsis">{{ $item->type }}</td>
                <td class="px-6 py-4 text-sm font-medium text-gray-800 dark:text-gray-200 max-w-[200px] text-ellipsis">{{ $item->remark }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
