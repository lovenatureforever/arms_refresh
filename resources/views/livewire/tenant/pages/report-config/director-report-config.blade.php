                    ...
                    <tr wire:sortable.item="{{ $item->id }}" wire:key="report-{{ $item->id }}">
                        <td class="px-6 py-4 text-sm font-medium text-gray-800 whitespace-nowrap dark:text-gray-200 max-w-[400px]">
                            ...
                            <button
                                ...
                                type="button"
                                title="Add"
                                wire:click="$dispatch('openModal', {component: 'tenants.modal.report.config.director-report-config', arguments: { companyId: {{ $this->companyId }}, isUpdate: false, id: {{ $item->id }} }})"
                            >
                            ...
                            <button
                                ...
                                type="button"
                                title="Edit"
                                wire:click="$dispatch('openModal', {component: 'tenants.modal.report.config.director-report-config', arguments: { companyId: {{ $this->companyId }}, isUpdate: true, id: {{ $item->id }} }})"
                            >
